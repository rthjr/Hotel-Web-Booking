...
const AboutDetails = () => {
  return (
    <div className=" w-12/12 h-screen flex justify-between">
      <div className="w-6/12 flex flex-col justify-center items-center gap-4">
        <div className="relative w-5/12 h-full lg:h-[50vh]">
      ...
      <div className="w-6/12  flex flex-col justify-center items-center gap-4 p-6">
        <p className="text-base">
          ...
          UN - and is also a symbol of the Organization's ideals and an advocate
          ...
          especially the poor and vulnerable. The Secretary-General is appointed
          by the General Assembly on the recommendation of the Security Council
          for a 5-year, renewable term. The current Secretary-General, and the
          9th occupant of the post, is António Guterres of Portugal, who took
          office on 1 January 2017. On the 18th of June, 2021, Guterres was
          re-appointed to a second term, pledging as his priority to continue
          helping the world chart a course out of the COVID-19 pandemic.
        </p>
      </div>
    </div>
  );
